...
stata_df = DataFrame(load("testing/testing.dta"))
df = DataFrame(CSV.File("data/clean/data_cleaned.csv"))

@testset "Testing mean values of newly generated vars for plots" begin
    
    columns_to_tes = [:fallmax_mex_frac, :springmax_mex_frac, :yrmax_Mexican, :yrmax_domestic_seasonal]
